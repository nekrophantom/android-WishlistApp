...
import dev.nekro.wishlistapp.presentation.screen.CreateEditDetailScreen
...
fun Navigation (viewModel: WishViewModel = viewModel(), navController: NavHostController = rememberNavController()) {
    ...
    NavHost(navController = navController, startDestination = Route.HomeScreen.route){
        ...
        composable(Route.CreateScreen.route + "/{id}",
            arguments =  listOf(
                navArgument("id"){
            ...
            CreateEditDetailScreen(id = id, viewModel = viewModel, navController = navController)
        }
